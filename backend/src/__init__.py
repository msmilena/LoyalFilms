...
cred = credentials.Certificate(r"C:\Users\milena.mitac\Desktop\LoyalFilms\LoyalFilms\backend\src\token\loyalfilsm-firebase-adminsdk-c3vxb-294f23391f (1).json")
